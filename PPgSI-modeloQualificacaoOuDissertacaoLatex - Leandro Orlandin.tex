...
%
%-------------------------------------------------------------------------
\titulo{A Importância da Acessibilidade Digital nas Aplicações Móveis: Um Estudo sobre as Avaliações de Usuários no Google Play Store}
...
%Orlandin - Retirado o item Simbolos por não haver casos no documento
%\begin{simbolos}
...
\chapter{Estudo exploratório e atividades já realizadas}
\label{chap:atividades}
\input{atividadesrealizadas}
