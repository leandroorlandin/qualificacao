...
\begin{itemize}
	...
	Poderão ser utilizados processamentos automatizados de análises que permitirão ganhar escalabilidade e por consequência abrangência. De acordo com \cite{Panichella2015how} os usuários aplicam o mesmo padrão de resposta quando a sua intenção é de reportar um problema.
