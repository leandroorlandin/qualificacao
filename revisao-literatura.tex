...
O estudo de \citeonline{ihc2019} analisa as avaliações feitas pelos usuários de um conjunto de 700 aplicações para identificar os aspectos de acessibilidade mencionados. Os detalhes deste artigo são apresentados na Seção~ \ref{chap:atividades} pois foi o estudo de viabilidade que subsidiou esta proposta de pesquisa.
